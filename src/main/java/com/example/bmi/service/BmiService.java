...
public class BmiService {
    ...
    public void saveUser(BmiBean bmiBean) {
    ...
    public BmiBean getBmiDataById(long id) {
        Optional<BmiBean> optionalBmi = bmiRepository.findById(id);
        return optionalBmi.orElse(null);
    }
